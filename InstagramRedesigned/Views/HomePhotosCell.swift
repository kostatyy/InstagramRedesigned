...
class HomePhotosCell: UICollectionViewCell {
    ...
    // Static Vars
    static let reuseId = "RelaxCellId"
    ...
    private func setupViews() {
        ...
        likesIcon.image = UIImage(systemName: "heart.fill")?.setColor(color: .white)
        ...
        [bgImage, userImage, userName, likesStack, likesIcon, commentsStack, commentsIcon, sendIcon, saveIcon, likesCount, commentsCount].forEach {
